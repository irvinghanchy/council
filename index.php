...
<body class="bg-base-200 min-h-screen flex items-center justify-center p-4 overflow-hidden">
  
<div class="max-w-md w-full grid gap-6 text-center z-10">
  
  <div class="animate-spring">
    <div class="avatar mb-2">
      <div class="w-32 rounded-full border border-base-300 p-2 bg-white">
        <img src="<?= BASE_URL ?>/assets/ASHSSP Logo.png" />
      </div>
    </div>
    <h1 class="text-3xl font-bold text-gray-800 tracking-tight">線上議事系統</h1>
    <p class="text-gray-500 mt-2 text-sm">高師大附中學生議會議事輔助平台</p>
  </div>

  <?php if ($err): ?>
  <div class="alert alert-error bg-red-50 text-red-600 border border-red-200 animate-spring delay-100 mx-auto">
  ...
  <div class="bento-card p-6 flex flex-col gap-4 animate-spring delay-200">
    <a href="<?= BASE_URL ?>/auth/google_login.php?as=member"
       class="btn btn-lg bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 gap-3 font-medium">
    ...
    <div class="divider text-xs text-gray-400 m-0">或</div>

    <a href="<?= BASE_URL ?>/auth/admin_login.php"
       class="btn btn-outline border-gray-300 text-gray-600 hover:bg-gray-100 hover:border-gray-400 gap-2">
      主辦人登入
    </a>
  </div>
</div>
